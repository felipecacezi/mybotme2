...
import { Star, Bot, CalendarCheck, BarChart } from "lucide-react";
        ...
        <Card className="lg:col-span-1">
          ...
          <div className="p-6 pt-0">
              <Button asChild className="w-full">
                  <Link href="/dashboard/planos">Gerenciar Assinatura</Link>
              </Button>
          </div>
        </Card>
        ...
        <CardHeader>
          <div className="flex flex-row items-center gap-2">
            ...
            <div>
              ...
              <CardDescription>Visão geral dos atendimentos e agendamentos nos últimos 7 dias.</CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent>
